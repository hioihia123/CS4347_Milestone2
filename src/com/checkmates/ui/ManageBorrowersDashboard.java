...
public class ManageBorrowersDashboard extends JFrame {
    ...
    public ManageBorrowersDashboard(Librarian libObj) {
        this.lib = libObj;
    ...
    private void initComponents() {
        ...
        // --- Header ---
        JLabel headerLabel = new JLabel("Borrower Management", SwingConstants.LEFT);
    ...
    private void loadLoanHistory() {
        new Thread(() -> {
            try {
                ...
                String urlString = "http://cm8tes.com/CS4347_Project_Folder/getBorrowers.php";
    ...
    private void updateTableWithJson(String jsonString) {
        try {
            ...
            if ("success".equalsIgnoreCase(json.optString("status"))) {
                ...
                String[] columnNames = {"Card ID", "Ssn", "Name", "Address", "Phone"};
                ...
                for (int i = 0; i < recordsArray.length(); i++) {
                    ...
                    String borSsn = obj.optString("Ssn");
                    String bName = obj.optString("Bname");
                    String borrowerAddress = obj.optString("Address");
                    String borrowerPhone = obj.optString("Phone");
                    
               

                    // Add Loan ID as the LAST element
                    rowData.add(new String[]{cId, borSsn,bName, borrowerAddress, borrowerPhone});
                }
    ...
    if (rowSorter != null) {
        if (text.trim().length() == 0) {
            ...
            // WRAP 'text' IN Pattern.quote()
            // This prevents crashes when typing '(', ')', '*', etc.
            try {
                rowSorter.setRowFilter(RowFilter.regexFilter("(?i)" + Pattern.quote(text)));
            } catch (java.util.regex.PatternSyntaxException e) {
                // If something still goes wrong, safely clear the filter
                rowSorter.setRowFilter(null);
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new ManageBorrowersDashboard(dummy).setVisible(true));
    }
}